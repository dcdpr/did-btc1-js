...
const receiver = 'n4CBvMmJ3XMajuNhMiuNx1cDHLBtwQbKRX'; // n4CBvMmJ3XMajuNhMiuNx1cDHLBtwQbKRX
...
const signer = {
  ...
  signSchnorr : (hash: Uint8Array) => multikey.sign(hash, { scheme: 'schnorr' }),
  sign        : (hash: Uint8Array) => multikey.sign(hash),
};
